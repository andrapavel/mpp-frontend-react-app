...
//         try {
//             console.log('Fetching teams with token:', token); // Log the token
...
//             console.log('Adding team with token:', token); // Log the token
...
const OverviewPage: React.FC = () => {
    ...
    const handleDeleteTeam = async (id: number) => {
        try {
            ...
            console.log('Deleting team with id:', id); // Log the id
